...
function transUnit(data, isSpeed) {
	...
	if (result == ""){
		result = "0 "+$.i18n.prop(isSpeed ? "main_connect_bps" : "main_connect_bps2");
	}
	if (isSpeed){
...
function getDisplayVolume(volume, isSpeed) {
    ...
    var labelForOneB = $.i18n.prop(isSpeed ? "main_connect_bps" : "main_connect_bps2");
    var labelForOneKB = $.i18n.prop(isSpeed ? "main_connect_kbps" : "main_connect_kbps2");
    var labelForOneMB = $.i18n.prop(isSpeed ? "main_connect_mbps" : "main_connect_mbps2");
    var labelForOneGB = $.i18n.prop(isSpeed ? "main_connect_gbps" : "main_connect_gbps2");
    var labelForOneTB = $.i18n.prop(isSpeed ? "main_connect_tbps" : "main_connect_tbps2");
    if (isSpeed) {
        volume = volume * 8;
    }
